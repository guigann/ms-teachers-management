...
public class InstructorManagerIntegrator implements InstructorManagerPortOut {
    ...
    public TeacherListDtoOutput get(String authorization, String origin) {
        log.info("[ADAPTER OUT - TeacherManagerIntegrator.get] - Enviando a requisicao para a operacao get da API Teachers Management");
        try {
    ...
    public TeacherDtoOutput getById(String authorization, String origin, Integer id) {
        log.info("[ADAPTER OUT - TeacherManagerIntegrator.getbyId] - Enviando a requisicao para a operacao getbyId da API Teachers Management");
        try {
    ...
    public TeacherDtoOutput save(String authorization, String origin, Instructor instructor) {
        log.info("[ADAPTER OUT - TeacherManagerIntegrator.save] - Enviando a requisicao para a operacao save da API Teachers Management");
        try {
